...
def argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "pdb", metavar="<.pdb>", type=os.path.abspath, help="Path to a target PDB file."
    )
    ...
    parser.add_argument(
        "-b", "--base_name", metavar="<str>", type=str, help="Prefix to output files."
    )
    parser.add_argument(
        "-O",
        "--output_directory",
    ...
    parameters.add_argument(
        ...
        default=5.0,
        type=_positive_float,
        help="Cavities volume filter (\u212B\u00b3). (default: %(default).1lf)",
    )
    parameters.add_argument(
        "-R",
        "--removal_distance",
        ...
        default=2.4,
        type=_positive_float,
        help="Length to be removed from the cavity-bulk frontier (\u212B). (default: %(default).1lf)",
    )
    parameters.add_argument(
        "-S",
        "--surface",
